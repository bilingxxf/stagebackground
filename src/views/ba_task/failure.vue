<template>
	<div id="historyTask">
		<div class="title">失败的任务</div>
		<div class="task-header">
			<div class="input">
				<el-input placeholder="请输入执行账号" v-model="performAccount" class="input-with-select" @keyup.enter.native="searchAccount">
					<el-button slot="append" icon="el-icon-search" @click="searchAccount"></el-button>
				</el-input>
				<el-input placeholder="请输入任务名称" v-model="performTask" class="input-with-select" @keyup.enter.native="searchTask">
